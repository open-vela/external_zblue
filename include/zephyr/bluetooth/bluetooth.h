...
struct bt_le_scan_param {
	/** Scan type (Z_BT_LE_SCAN_TYPE_ACTIVE or Z_BT_LE_SCAN_TYPE_PASSIVE) */
	uint8_t  type;
 ...
 *
 * @param _type     Scan Type, Z_BT_LE_SCAN_TYPE_ACTIVE or
 *                  Z_BT_LE_SCAN_TYPE_PASSIVE.
 ...
 */
#define BT_LE_SCAN_ACTIVE BT_LE_SCAN_PARAM(Z_BT_LE_SCAN_TYPE_ACTIVE, \
 ...
 */
#define BT_LE_SCAN_ACTIVE_CONTINUOUS BT_LE_SCAN_PARAM(Z_BT_LE_SCAN_TYPE_ACTIVE, \
						      BT_LE_SCAN_OPT_FILTER_DUPLICATE, \
 ...
 */
#define BT_LE_SCAN_PASSIVE BT_LE_SCAN_PARAM(Z_BT_LE_SCAN_TYPE_PASSIVE, \
					    BT_LE_SCAN_OPT_FILTER_DUPLICATE, \
					    BT_GAP_SCAN_FAST_INTERVAL, \
					    BT_GAP_SCAN_FAST_WINDOW)
 ...
 * (e.g., UUID) are known to be placed in Advertising Data.
 */
#define BT_LE_SCAN_PASSIVE_CONTINUOUS BT_LE_SCAN_PARAM(Z_BT_LE_SCAN_TYPE_PASSIVE, \
						       BT_LE_SCAN_OPT_FILTER_DUPLICATE, \
						       BT_GAP_SCAN_FAST_INTERVAL_MIN, \
						       BT_GAP_SCAN_FAST_WINDOW)
BUILD_ASSERT(BT_GAP_SCAN_FAST_WINDOW == BT_GAP_SCAN_FAST_INTERVAL_MIN,
...
#define BT_LE_SCAN_CODED_ACTIVE \
		BT_LE_SCAN_PARAM(Z_BT_LE_SCAN_TYPE_ACTIVE, \
...
#define BT_LE_SCAN_CODED_PASSIVE \
		BT_LE_SCAN_PARAM(Z_BT_LE_SCAN_TYPE_PASSIVE, \
				 BT_LE_SCAN_OPT_CODED | \
				 BT_LE_SCAN_OPT_FILTER_DUPLICATE, \
				 BT_GAP_SCAN_FAST_INTERVAL, \
				 BT_GAP_SCAN_FAST_WINDOW)
 ...
 *       Z_BT_LE_SCAN_TYPE_ACTIVE. Supplying a non-zero timeout will result in an
 *       -EINVAL error code.
 *
